 ...
 */
public abstract class PersistenceTest extends org.junit.Assert {
   ...
   // private static final jdk.nashorn.internal.runtime.logging.Logger logger = LoggerFactory.getLogger(PersistenceTest.class);
